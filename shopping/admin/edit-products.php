...
if(isset($_POST['submit']))
{
	...
	$query=mysqli_query($con,"select productName from products where id='pid'");
	$result=mysqli_fetch_row($query);
	$pname=$result['productName'];
		
	if(!empty($pname) && !empty($productname)) {
...
$query=mysqli_query($con,"select products.*,category.categoryName as catname,category.id as cid,subcategory.subcategory as subcatname,subcategory.id as subcatid from products 
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($row['productName']);?>/<?php echo htmlentities($row['productImage1']);?>" width="200" height="100"> <a href="update-image1?id=<?php echo $row['id'];?>">Change Image</a>
</div>
</div>
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($row['productName']);?>/<?php echo htmlentities($row['productImage2']);?>" width="200" height="100"> <a href="update-image2?id=<?php echo $row['id'];?>">Change Image</a>
</div>
</div>
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($row['productName']);?>/<?php echo htmlentities($row['productImage3']);?>" width="200" height="100"> <a href="update-image3?id=<?php echo $row['id'];?>">Change Image</a>
</div>
</div>
<?php } ?>
	<div class="control-group">
