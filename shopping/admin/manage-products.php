...
?>									
										<tr>
											...
											<td>
											<a href="edit-products?id=<?php echo $row['id']?>" ><i class="icon-edit"></i></a>
											<a href="manage-products?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
