...
<?php if(strlen($_SESSION['login']))
    {   ?>
				...
				<?php } ?>
					...
					<li><a href="my-account"><i class="icon fa fa-user"></i>My Account</a></li>
...
<?php }
				...
				<li><a href="logout"><i class="icon fa fa-sign-out"></i>Logout</a></li>
				<?php } ?>	
				</ul>
			</div><!-- /.cnt-account -->
...
<div class="cnt-block">
				<ul class="list-unstyled list-inline">
					<li class="dropdown dropdown-small">
						<a href="track-orders" class="dropdown-toggle" ><span class="key">Track Order</b></a>
