...
mysqli_query($con,"insert into orders(userId,productId,quantity, orderDate) values('".$_SESSION['id']."','$qty','$val34', '$today')");
header('location:payment-method');
}
}
}
...
if(!empty($_SESSION['cart'])){
	?>
		<table class="table table-hover .table table-striped">
			<thead class="thead-dark" style="background-color: #21bf5f; color: white;">
				<tr>
				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index" class="btn btn-upper btn-info outer-left-xs">Continue Shopping</a>
	...
	?>
				...
				<tr>
					...
					<td class="cart-product-name-info">
						<h4 class='cart-product-description'><a href="product-details?pid=<?php echo htmlentities($pd=$row['id']);?>" ><?php echo $row['productName'];
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">PROCCED TO CHEKOUT</a></button>
