...
<div class="body-content outer-top-bd">
	...
	<div class="table-responsive">
		<table class="table table-hover .table table-striped">
			<thead>
				<tr>
					<th colspan="4" style="background-color: #1d4264;color:hotpink;">my wishlist</th>
				</tr>
			</thead>
			<br/>
			<tbody>
...
?>
				...
				<tr>
					...
					<td class="col-md-6">
						<div class="product-name"><a href="product-details?pid=<?php echo htmlentities($pd=$row['pid']);?>"><?php echo htmlentities($row['pname']);?></a></div>
...
?>
					...
					<td class="col-md-2">
						<a href="my-wishlist?page=product&action=add&id=<?php echo $row['pid']; ?>" class="btn-upper btn btn-info">Add to cart</a>
					</td>
					<td class="col-md-2 close-btn">
						<a href="my-wishlist?del=<?php echo htmlentities($row['wid']);?>" onClick="return confirm('Are you sure you want to delete?')" class=""><i class="fa fa-times"></i></a>
					</td>
				</tr>
				<?php } } else{ ?>
				<tr>
