    ...
    ?>
	    	<div class="accordion-group">
	            <div class="accordion-heading">
	                <a href="category?cid=<?php echo $row['id'];?>"  class="accordion-toggle collapsed">
...
?>
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							<h3 class="name"><a href="product-details?pid=<?php echo htmlentities($rws['id']);?>"><?php echo htmlentities($rws['productName']);?></a></h3>
						...
						<a href="product-details?page=product&action=add&id=<?php echo $rws['id']; ?>" class="lnk btn btn-info">Add to cart</a>
...
<div class="stock-container info-container m-t-10">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="favorite-button m-t-10">
											<a class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Wishlist" href="product-details?pid=<?php echo htmlentities($row['id'])?>&&action=wishlist">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
										<a href="product-details?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> ADD TO CART</a>
									</div>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details?pid=<?php echo htmlentities($rw['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($rw['productName']);?>/<?php echo htmlentities($rw['productImage1']);?>" width="150" height="240" alt=""></a>
			</div><!-- /.image -->			
		...
		<div class="product-info text-left">
			<h3 class="name"><a href="product-details?pid=<?php echo htmlentities($rw['id']);?>"><?php echo htmlentities($rw['productName']);?></a></h3>
			<div class="rating rateit-small"></div>
			...
			<div class="product-price">	
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">Add to cart</a>
